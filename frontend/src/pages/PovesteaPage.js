      ...
      return (
        <div className="content-section">
          ...
          <div className="story-content">
            ...
            <p>
              La Cofetarie a început ca o visare simplă în bucătăria bunicii
              noastre, unde aromele de vanilie și ciocolată se amestecau cu
              râsetele copilăriei. Fiecare rețetă transmisă din generație în
              generație aduce cu ea o poveste, o amintire, o emoție.
            </p>

            <h3>Pasiunea pentru perfecțiune</h3>
            <p>
              În fiecare zi, echipa noastră dedicată transformă ingredientele
              cele mai proaspete în creații culinare care nu doar că satisfac
              pofta, ci și inima. Fiecare prăjitură, fiecare biscuit, fiecare
              bomboană este creată cu grijă și dragoste.
            </p>
          </div>
        </div>
      );
